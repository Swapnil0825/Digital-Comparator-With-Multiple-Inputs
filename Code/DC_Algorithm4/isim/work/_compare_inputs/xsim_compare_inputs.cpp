#include "isim/work/_compare_inputs/_compare_inputs.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("CompareInputs", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF1);
        HSim__s5 * topvl = 0;
        topvl = new workM_compare_inputs("CompareInputs");
